...
include("./debut.php");
include("./menu.php");
echo '<p><i>Vous etes ici</i> : <a href="./index.php">Index du forum</a> --> Enregistrement';
...
if (empty($_POST['pseudo'])) // Si on la variable est vide, on peut considérer qu'on est sur la page de formulaire
{
	...
	<label for="pseudo">* Pseudo :</label>  <input name="pseudo" type="text" id="pseudo" /> (le pseudo doit contenir entre 3 et 15 caracteres)<br />
	...
	<label for="signature">Signature :</label><textarea cols="40" rows="4" name="signature" id="signature">La signature est limitee a 200 caracteres</textarea>
	</fieldset>
	<p>Les champs precedes d un * sont obligatoires</p>
